...
public class GuidangjianmuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public GuidangjianmuEntity() {
		
	}
	
	public GuidangjianmuEntity(T t) {
		try {
	 ...
	 * 设置：建目编号
	 */
	public void setJianmubianhao(String jianmubianhao) {
		this.jianmubianhao = jianmubianhao;
	}
	/**
	 * 获取：建目编号
	 */
	public String getJianmubianhao() {
		return jianmubianhao;
	}
	/**
	 * 设置：文件名称
	 */
