		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"90%","margin":"0 auto 20px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","display":"flex"}'>
					<el-button :style='{"border":"2px solid rgba(38, 93, 248, 1)","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"rgba(38, 93, 248, 1)","borderRadius":"40px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('guihaidangan','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"2px solid rgba(38, 93, 248, 1)","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"rgba(38, 93, 248, 1)","borderRadius":"40px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('guihaidangan','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' v-if="isAuth('guihaidangan','审核')" prop="sfsh" label="审核">
						<template slot-scope="scope">
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          danganzhuangtai: row.danganzhuangtai,
