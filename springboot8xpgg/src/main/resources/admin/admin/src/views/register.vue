<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220808/e522818889194f23be4bd8d73c54a2a8.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"20px 50px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","borderRadius":"10px","background":"rgba(248, 246, 240, 1)","width":"500px","position":"absolute","right":"100px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 20px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","fontWeight":"600","height":"auto"}' class="title">档案管理系统注册</div>
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"20px auto 15px","outline":"none","color":"#fff","borderRadius":"8px","background":"rgba(38, 93, 248, 1)","display":"block","width":"80%","fontSize":"16px","height":"44px"}' type="button" class="r-btn" @click="login()">注册</button>
...
<style lang="scss" scoped>
	.container {
	  position: relative;
	  background: url(http://codegen.caihongy.cn/20220808/e522818889194f23be4bd8d73c54a2a8.png);
